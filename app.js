      ...
      if (isMobile) {
        ...
        img.onload = function() {
          ...
          if (newWindow) {
            newWindow.document.write(`
              ...
              <body>
                <div class="instructions">
                  <strong>📥 Save to Phone:</strong><br>
                  Long-press image below → Select "Save Image"<br>
                  <button class="close-btn" onclick="this.parentElement.style.display='none'">Got it!</button>
                </div>
            ...
            alert('Please allow pop-ups, then long-press image to save.');
          }
