// KSIJ Poster Editor App - SIMPLE DROPDOWN THEME SYSTEM
...
function createThemeDropdown(type, element) {
  ...
  // Options
  const options = [
    { value: 'regular', text: '🟢 Regular', color: '#2a9d4e' },
    { value: 'shahadat', text: '⚫ Shahadat', color: '#424242' },
    { value: 'wiladat', text: '🔴 Wiladat', color: '#c62828' }
  ];
  ...
  select.onchange = function() {
    ...
    if (type === 'programme') {
      ...
      if (theme === 'shahadat') element.classList.add('prog-header-box-shahadat');
      if (theme === 'wiladat') element.classList.add('prog-header-box-wiladat');
      
      // Find and change badge
      let next = element.nextElementSibling;
      while (next) {
        if (next.classList.contains('prog-badge')) {
          next.classList.remove('prog-badge-shahadat', 'prog-badge-wiladat');
          if (theme === 'shahadat') next.classList.add('prog-badge-shahadat');
          if (theme === 'wiladat') next.classList.add('prog-badge-wiladat');
          break;
        }
      ...
      if (theme === 'shahadat') element.classList.add('notice-shahadat');
      if (theme === 'wiladat') element.classList.add('notice-wiladat');
    }
