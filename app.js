...
async function downloadPNG() {
  ...
  loading.style.cssText = `
    ...
    border-radius: 10px; z-index: 10000; text-align: center; font-size: 16px;
  `;
  ...
  try {
    ...
    if (isMobile) {
      // MOBILE: Show image inline in overlay (NO POPUP)
      canvas.toBlob(function(blob) {
        ...
        overlay.innerHTML = `
          <div style="padding: 20px;">
            <div style="background: #667eea; color: white; padding: 15px; border-radius: 10px; margin-bottom: 15px; text-align: center;">
              <div style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">📥 Save to Your Phone</div>
              <div style="font-size: 14px; line-height: 1.8;">
                <strong>iPhone:</strong> Long-press image → "Save Image"<br>
                <strong>Android:</strong> Long-press image → "Download image"
              </div>
            </div>
            <img src="${url}" style="width: 100%; border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.5); display: block;">
