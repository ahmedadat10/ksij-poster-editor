...
async function downloadPNG() {
  ...
  try {
    ...
    if (isMobile) {
      ...
      overlay.innerHTML = '<div style="padding:20px;"><div style="background:#667eea;color:white;padding:15px;border-radius:10px;margin-bottom:15px;text-align:center;"><div style="font-size:18px;font-weight:bold;margin-bottom:10px;">📥 Save to Phone</div><div style="font-size:14px;line-height:1.8;"><strong>iPhone:</strong> Long-press image → "Save Image"<br><strong>Android:</strong> Long-press → "Download image"</div></div><img src="' + dataUrl + '" style="width:100%;border-radius:10px;box-shadow:0 4px 20px rgba(0,0,0,0.5);display:block;"><button id="closeBtn" style="width:100%;padding:15px;margin-top:15px;background:#667eea;color:white;border:none;border-radius:10px;font-size:16px;font-weight:bold;">✕ Close</button></div>';
