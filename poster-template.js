...
.word-weekly{background:linear-gradient(135deg,#d4a017 0%,#f5d155 50%,#d4a017 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-style:italic;filter:drop-shadow(0 4px 20px rgba(212,160,23,0.5));margin-right:20px}
