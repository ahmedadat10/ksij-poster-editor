...
.ksij-logo{width:80px;height:80px;flex-shrink:0;position:relative;border:3px solid #d4a017;border-radius:50%;padding:4px;background:linear-gradient(135deg,#f5d155,#d4a017);box-shadow:0 0 20px rgba(212,160,23,0.6),inset 0 2px 8px rgba(255,255,255,0.3)}
...
.word-weekly{background:linear-gradient(135deg,#fff 0%,#f5d155 50%,#fff 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-right:20px}
.word-programme{background:linear-gradient(135deg,#d4a017 0%,#f5d155 50%,#d4a017 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-style:italic;filter:drop-shadow(0 4px 20px rgba(212,160,23,0.5))}
...
.date-strip p{font-size:24px;font-weight:800;color:#fff;letter-spacing:2.5px;text-transform:uppercase;margin:6px 0;position:relative;z-index:1}
...
.prayers td.pl .prayer-icon{position:absolute;left:8px;top:50%;transform:translateY(-50%);font-size:14px;cursor:pointer}
