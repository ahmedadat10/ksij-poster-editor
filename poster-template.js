// KSIJ Poster - ENHANCED VERSION with All 5 Visual Improvements
...
.ksij-logo{width:80px;height:80px;flex-shrink:0;position:relative}
...
.ksij-logo img{width:100%;height:100%;object-fit:contain;position:relative;z-index:1}
...
/* Weekly Programme with Gold Gradient */
.weekly-wrap{text-align:center;padding-bottom:24px;position:relative}
.weekly{font-family:'Playfair Display',serif;font-size:78px;font-weight:900;background:linear-gradient(135deg,#fff 0%,#f5d155 50%,#fff 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:4px;line-height:1;text-shadow:0 4px 20px rgba(0,0,0,0.35);display:block}
.programme{font-family:'Playfair Display',serif;font-size:82px;font-weight:700;font-style:italic;background:linear-gradient(135deg,#d4a017 0%,#f5d155 50%,#d4a017 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:2px;line-height:1;filter:drop-shadow(0 4px 20px rgba(212,160,23,0.5));display:block;margin-top:-4px;position:relative}
...
/* ===== 2. ENHANCED DATE STRIP ===== */
.date-strip-wrap{margin-top:-2px;padding:0 28px;position:relative;z-index:1}
.date-strip{background:linear-gradient(135deg,#1a7a38,#2a9d4e 40%,#1a7a38);border-radius:0 0 10px 10px;padding:32px 40px;text-align:center;box-shadow:0 8px 28px rgba(0,0,0,0.22),inset 0 2px 8px rgba(255,255,255,0.2);border-left:6px solid #d4a017;border-right:6px solid #d4a017;border-bottom:5px solid #d4a017;position:relative;overflow:hidden}
...
.date-strip p{font-size:20px;font-weight:800;color:#fff;letter-spacing:2.5px;text-transform:uppercase;margin:4px 0;position:relative;z-index:1}
...
/* ===== BODY ===== */
.body-wrap{padding:22px 28px 0;position:relative;z-index:1}
...
/* ===== 3. PRAYER TIMES WITH ICONS AND ZEBRA STRIPES ===== */
...
.prayers td.pl{font-weight:600;color:#222;text-transform:uppercase;letter-spacing:0.4px;background:linear-gradient(90deg,#f2fbf5 0%,rgba(242,251,245,0.5) 100%);padding-left:32px}
.prayers td.pl::before{content:'🕌';position:absolute;left:8px;top:50%;transform:translateY(-50%);font-size:14px}
...
/* ===== 4. PROGRAMME SCHEDULE WITH STAR BULLETS ===== */
...
/* ===== HADITH STRIP ===== */
.hadith-strip-wrap{padding:0 28px 22px;position:relative;z-index:1}
...
/* ===== FOOTER ===== */
.footer-strip{background:#fff;padding:16px 28px;border-top:3px solid #2a9d4e;position:relative;z-index:1}
...
.bottom-border{height:10px;background:linear-gradient(90deg,#7a4e00,#d4a017,#f5d155,#ffffff,#f5d155,#d4a017,#7a4e00)}
  ...
  <div class="header">
    <div class="header-content">
      <div class="brand-row">
        <div class="ksij-logo">
          <img src="data:image/png;base64,${LOGO_BASE64}" alt="KSIJ Kampala">
        </div>
